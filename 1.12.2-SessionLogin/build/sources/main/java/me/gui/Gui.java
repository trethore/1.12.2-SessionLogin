...
public class Gui extends GuiScreen {
	...
	public void initGui() {
		...
		sessionField = new GuiTextField(1, mc.fontRenderer, sr.getScaledWidth() / 2 - 100, sr.getScaledHeight() / 2,
				200, 20);
	...
	public void drawScreen(int mouseX, int mouseY, float partialTicks) {
		...
		mc.fontRenderer.drawString("username:token:uuid",
				sr.getScaledWidth() / 2 - mc.fontRenderer.getStringWidth("Username:token:uuid") / 2,
		...
		mc.fontRenderer.drawString(status, sr.getScaledWidth() / 2 - mc.fontRenderer.getStringWidth(status) / 2,
